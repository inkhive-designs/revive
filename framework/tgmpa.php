...
add_action( 'tgmpa_register', 'revive_register_required_plugins' );
 ...
 */
function revive_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'		  => __('WPForms-Lite Contact Form Plugin', 'revive'),
			'slug'		  => 'wpforms-lite',
			'required'	  => false
		),
	 ...
	 */
	$config = array(
		'id'           => 'revive',                 // Unique ID for hashing notices for multiple instances of TGMPA.
